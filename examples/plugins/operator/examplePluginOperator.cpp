...
int main(int argc, char *argv[])
{
    ...
    try
    {
        ...
        var.AddOperation("plugin", {{"PluginName", "OperatorPlugin"}});
        //var.AddOperation("bzip2", {{"accuracy", "0.01"}});

        // TODO this won't work because operator doesn't have access to IO object
        //io.SetParameters({{"PluginName", "ExampleOperator"}});
        //io.SetParameters({{"PluginLibrary", "OperatorPlugin"}});
